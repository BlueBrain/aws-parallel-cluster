...
VALUES=(HPC_ENVIRONMENT HPC_HEAD_NODE HPC_PATH_PREFIX HPC_SIF_PREFIX HPC_DATA_PREFIX \
        KC_HOST KC_SCR KC_REALM NEXUS_BASE NEXUS_ORG NEXUS_PROJ NEXUS_TOKEN NEXUS_WORKFLOW \
